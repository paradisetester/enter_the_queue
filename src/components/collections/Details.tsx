...
import { FaFacebookF, FaInstagram, FaTwitter, FaDiscord, FaEthereum } from "react-icons/fa";
...
interface DetailProps {
  ...
  id: string;
  useFilter?: any
  nfts?: CollectionDataProps;
}

function Details({ collection, id, useFilter, nfts }: any) {
        ...
        <div className="lg:flex md:flex block collectionsingle_data_row">
                ...
                <h2 className="dark:text-white text-[#000] font-semibold	text-lg	home-collection_heading_badge flex items-center">
                  {toCaptalize(collection.name)}
                  {
                    collection.isVarified ? (
                      <Tooltip title={"Verified"} placement="right-end">
                        <Button>
                          <HiBadgeCheck />
                        </Button>
                      </Tooltip>
          ...
          >
            <div className="flex items-center justify-end" >
              ...
              {isAuthenticated && collection?.creator?.id === user?.id ? (
                <Link
                  href={`/nft/create#${collection.id}`}
                  legacyBehavior
                  passHref
                >
                  <div className="myprofile_onsale_column_box_socialicons cursor-pointer">
                    <Tooltip title="Create new nft">
                      <AiFillPlusSquare />
                    </Tooltip>
                  </div>
                </Link>
            ...
            <div className="collectionsingle_items_row_col flex justify-center  lg:mt-10 md:mt-10 mt-0 flex-wrap " >
              ...
              >
                <div className="text-center">
                  <h6 className=" dark:text-[#707a83] text-[#707a83] text-3xl">{collection.nftCount}</h6>
              ...
              >
                <div className="text-center">
                  <h6 className=" dark:text-[#707a83] text-3xl text-[#707a83] "><FaEthereum size={22} style={{
              ...
              >
                <div className="text-center">
                  <h6 className=" dark:text-[#707a83] text-3xl text-[#707a83] ">{volumeUsed}</h6>
          ...
          >
            ...
            <Tabs>
              ...
              <TabPanel className="reatordetail_tabs  searchpage_tabs_panel">
                <CommonFilter onToggle={handleToggle} useFilter={useFilter} id={id} pathname="collections"/>
