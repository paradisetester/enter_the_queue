...
const Details: FC<DetailsProps> = ({ creator, id, useFilter, nfts, collected }, props: any) => {
            ...
            >
              <Tabs>
                ...
                <TabPanel className="reatordetail_tabs  searchpage_tabs_panel">
                  <CommonFilter onToggle={handleToggle} useFilter={useFilter} id={id} pathname="creators" />
                  <div className="container-fluid mx-auto  ">
                    {
                      !isLoading ? (
                        <>
