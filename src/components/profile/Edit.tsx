...
function EditProfile() {
    ...
    const uploadAssetsOnIPFS = async () => {
        ...
        if (assets.image) {
            newFormData.image = getIPFSBaseUrl(await uploadOnIPFSServer(assets.image[0]));
        }
        if (assets.banner) {
            newFormData.banner = getIPFSBaseUrl(await uploadOnIPFSServer(assets.banner[0]));
        }
            ...
            <div className="container-fluid mx-auto ">
                <div className="lg:flex md:flex block flex-row">
                    <div className="basis-4/12  profile_edit_left_col px-10 pt-10 lg:pb-0  md:pb-0  pb-10 dark:bg-[#0f1740] bg-[#fafafa]" data-aos="fade-right" data-aos-duration="3000">
                        <div className="dark:bg-[#0f1740]  border-rounded-lg lg:p-10 md:p-0 p-0">
                                ...
                                <form className="w-full mb-10 mt-8 " data-aos="zoom-in" data-aos-duration="3000">
                                    ...
                                    <div className="grid grid-cols-1 lg:mb-5 md:mb-5 mb-0">
                                        <div className=" px-3 mb-6 md:mb-0">
                                            ...
                                            <input className={inputStyle} type="email" name='email' value={formData.email} onChange={handleChange} placeholder="Email">
                                            </input>
                                        </div>
                                    </div>
