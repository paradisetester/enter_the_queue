...
function Profile({ useFilter, collected, nfts, collections }: any) {
  ...
  return <>
    ...
    <section className="collectionsingle profile_single_bannerimage">
    ...
    <section className="collectionsingle lg:px-14 md:px-5 px-0 pb-10 pt-4 profile_single_data">
              ...
              <div className="single creator_leftbox">
                <h2 className="dark:text-white text-[#000] font-semibold	text-lg	home-collection_heading_badge flex items-center">
                  ...
                  {loginUser.isVarified && (
                    <Tooltip title={"Verified"} color="primary" placement="right-end">
                      <Button>
                        <HiBadgeCheck />
                      </Button>
                    </Tooltip>
    ...
    <section className="bg-[#fafafa] dark:bg-[#0f1740]">
      <div className="container mx-auto">
        <div className="">
          <div
            className="basis-12/12 myprofile_page_pr0file_row_image_content pt-10 pb-0 profile_single_tabs"
            data-aos="fade-up"
            data-aos-anchor-placement="top-bottom"
            data-aos-delay="300"
            data-aos-duration="2000"
