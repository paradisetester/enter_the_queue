...
const NotificationDropdown = () => {
  ...
  const ScrollWrapper = ({ children }: { children: ReactNode }) => {
    if (hidden) {
      return <Box
        component="div" sx={{ ...styles, overflowY: 'auto', overflowX: 'hidden' }}>{children}</Box>
    } else {
      return (
    ...
    <Fragment>
      ...
      >
        <MenuItem disableRipple>
          <Box
            component="div" sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
        ...
        <ScrollWrapper>
          <MenuItem onClick={handleDropdownClose}>
            <Box
              component="div" sx={{ width: '100%', display: 'flex', alignItems: 'center' }}>
              <Avatar alt='Flora' src='/images/avatars/4.png' />
              <Box
                component="div" sx={{ mx: 4, flex: '1 1', display: 'flex', overflow: 'hidden', flexDirection: 'column' }}>
