...
const Navigation = (props: Props) => {
  ...
  return (
    <Drawer {...props}>
      ...
      />
      <Box
            component="div" sx={{ height: '100%', position: 'relative', overflow: 'hidden' }}>
        {/* @ts-ignore */}
        <ScrollWrapper
        ...
        >
          ...
          <Box
            component="div" sx={{ height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
