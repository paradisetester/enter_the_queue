...
const CardStatsVertical = (props: CardStatsVerticalProps) => {
  ...
  return (
    <Card>
      <CardContent>
        <Box
            component="div" sx={{ display: 'flex', marginBottom: 5.5, alignItems: 'flex-start', justifyContent: 'space-between' }}>
        ...
        <Box
            component="div" sx={{ marginTop: 1.5, display: 'flex', flexWrap: 'wrap', marginBottom: 1.5, alignItems: 'flex-start' }}>
