...
import { NFT_ABI, NFT_ADDRESS, NFT_MARKET_PLACE_ABI, NFT_MARKET_PLACE_ADDRESS, providerOptions } from "../utils";
...
export const getTransactionOptions = async (provider: any = {}) => {
    try {
